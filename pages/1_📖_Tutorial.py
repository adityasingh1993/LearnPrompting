...
import config
from core.prompt_templates import ALL_TEMPLATES, format_prompt
from core.llm_client import generate, generate_multiple, is_api_key_configured
from core.evaluator import evaluate_quality
from core.scenarios import get_recommended_scenario
from utils.ui_components import (
    inject_custom_css, page_header, metric_card, score_badge,
    technique_card, response_panel, api_key_warning,
)
from utils.scoring import get_score_color, improvement_percentage, format_latency
